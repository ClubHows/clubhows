...
import { colorForName, deepFreeze } from 'grommet/utils';

const brandColor = '#5eb8dc';
...
export default deepFreeze({
  global: {
    ...
    focus: {
      border: {
        color: css`
          ${props => colorForName('accent-1', props.theme)};
        `,
        width: '2px'
      }
    },
    ...
    hover: {
      backgroundColor: css`
        ${props => props.theme.global.colors.active};
      `,
      textColor: '#000000'
    },
    input: {
      border: {
        ...
        radius: '4px',
        color: css`
          ${props => props.theme.global.colors.border};
        `
      }
    },
    lineHeight: '24px',
  ...
  button: {
    ...
    colors: {
      ...
      `,
      critical: css`
        ${props => props.theme.global.colors.status.critical};
      `,
      secondary: css`
        ${props => colorForName('neutral-2', props.theme)};
      `,
      text: css`
  ...
  clock: {
    circle: {
      color: {
        day: css`
          ${props => colorForName('light-3', props.theme)};
        `,
        night: css`
          ${props => colorForName('dark-2', props.theme)};
        `
      },
      width: '2px'
    },
    hour: {
      color: {
        day: css`
          ${props => colorForName('dark-1', props.theme)};
        `,
        night: css`
          ${props => colorForName('white', props.theme)};
        `
      },
      width: '3px',
      size: `${baseSpacing}px`,
    ...
    minute: {
      color: {
        day: css`
          ${props => colorForName('dark-4', props.theme)};
        `,
        night: css`
          ${props => colorForName('light-6', props.theme)};
        `
      },
      width: '2px',
    ...
    second: {
      color: {
        day: css`
          ${props => colorForName('accent-2', props.theme)};
        `,
        night: css`
          ${props => colorForName('accent-2', props.theme)};
        `
  ...
  rangeInput: {
    track: {
      color: css`
        ${props => rgba(props.theme.global.colors.text, 0.2)};
      `
    }
  },
  text: {
